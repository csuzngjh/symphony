defmodule SymphonyElixir.Config.Schema do
  ...
  defmodule Workspace do
    ...
    embedded_schema do
      ...
      field(:source_checkout_path, :string)
    end

    @spec changeset(%__MODULE__{}, map()) :: Ecto.Changeset.t()
    def changeset(schema, attrs) do
      schema
      |> cast(attrs, [:root, :source_checkout_path], empty_values: [])
    end
  end
  ...
  defmodule Agent do
    ...
    embedded_schema do
      ...
      field(:workspace_activity_scan_interval_ms, :integer, default: 15_000)
    end
    ...
    def changeset(schema, attrs) do
      ...
      |> cast(
        ...
        [
          ...
          :read_timeout_ms,
          :stall_timeout_ms,
          :workspace_activity_scan_interval_ms
        ],
        empty_values: []
      )
      ...
      |> validate_number(:workspace_activity_scan_interval_ms, greater_than: 0)
  ...
  defmodule Review do
    ...
    embedded_schema do
      ...
      field(:max_concurrent, :integer, default: 4)
    end

    @spec changeset(%__MODULE__{}, map()) :: Ecto.Changeset.t()
    def changeset(schema, attrs) do
      schema
      |> cast(attrs, [:enabled, :timeout_ms, :max_concurrent], empty_values: [])
      |> validate_number(:timeout_ms, greater_than: 0)
